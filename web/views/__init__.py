...
from web.views.home import home_view, terms_of_service_view, about_view
from web.views.profile import profile_view
from web.views.reports import report_create_view, report_detail_view, my_reports_view, report_delete_view, report_edit_view
